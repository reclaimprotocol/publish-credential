...
export default function ArbVeraxAttestor({
    provider,
    proof
}: {
    provider: string
    ...
    useEffect(() => {
        ...
        const ad = {
            data: {
                proof: proofReq,
                _identityCommitment: newIdentity?.commitment.toString().substring(0, 10),
                expirationTime: 1
            },
            schema:
    ...
    const contractAddress = '0x00F6528Ba7FB5dF300b0fb19CC901EDf0F28D255'
