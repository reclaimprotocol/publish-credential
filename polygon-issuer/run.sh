...
ONCHAIN_ISSUER_DID="did:polygonid:polygon:mumbai:2qCU58EJgrELUhM8QJKmiWeQ5V75A9HzskqxFbmQ2K"

ONCHAIN_ISSUER_CONTRACT_ADDRESS=0x169Fe90Cd62ca36500cAea06c50Fb7002A00a074
URL_MUMBAI_NODE='https://polygon-mumbai.infura.io/v3/{{key}}'
URL_POLYGON_NODE='https://polygon-mainnet.infura.io/v3/{{key}}'
